...
public class StartTip : MonoBehaviour
{
    ...
    private Color initialColor = Color.white; // Initial color of the text (white)
    ...
    private void Start()
    {
        ...
        if (myToggle.isOn && colorCoroutine == null)
        {
            colorCoroutine = StartCoroutine(ChangeStartTextColor());
        }
    }
    ...
    private void Update()
    {
        ...
        if (myTipsController.showingTips)
        {
    ...
    IEnumerator ChangeStartTextColor()
    {
